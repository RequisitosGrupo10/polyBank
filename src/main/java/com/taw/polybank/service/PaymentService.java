...
public class PaymentService {
  ...
  public PaymentEntity toEntity(
      ...
      BadgeService badgeService) {
    PaymentEntity payment =
        paymentRepository.findById(paymentDTO.getId()).orElse(new PaymentEntity());
    ...
    CurrencyExchangeEntity currencyExchangeEntity =
        paymentDTO.getCurrencyExchangeByCurrencyExchangeId() == null
            ? null
            : currencyExchangeService.toEntity(
                paymentDTO.getCurrencyExchangeByCurrencyExchangeId(), badgeService);
