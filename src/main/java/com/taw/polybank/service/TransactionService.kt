...
class TransactionService {
  ...
  fun findTransactionsByBankAccountByBankAccountIdId(bankId: Int): MutableList<TransactionDTO?> = transactionRepository!!
  ...
  fun findAllTransactionsByBankAccountAndDatesAndSendAmountInRange(
    ...
    minAmount: Double,
    maxAmount: Double,
  ): MutableList<TransactionDTO?> = transactionRepository!!
  ...
  private fun findByBankIdSortByTimestampDesc(id: Int?): MutableList<TransactionDTO?> = getDtoList(transactionRepository!!.findByBankIdSortByTimestampDesc(id))

  private fun findByBankIdSortByTimestampAsc(id: Int?): MutableList<TransactionDTO?> = getDtoList(transactionRepository!!.findByBankIdSortByTimestampAsc(id))
  ...
  private fun findCurrencyExchangesByBankIdAndMinimumAmountSortByTimestampAsc(
    id: Int?,
    amount: Double,
  ): MutableList<TransactionDTO?> = getDtoList(
  ...
  private fun findByClientIdSortByTimestampDesc(id: Int?): MutableList<TransactionDTO?> = getDtoList(transactionRepository!!.findByClientIdSortByTimestampDesc(id))

  private fun findByClientIdSortByTimestampAsc(id: Int?): MutableList<TransactionDTO?> = getDtoList(transactionRepository!!.findByClientIdSortByTimestampAsc(id))
