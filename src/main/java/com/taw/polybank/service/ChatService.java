...
public class ChatService {
  ...
  public List<ChatDTO> findByEmployeeAndClientDniAndClientName(
      EmployeeDTO employee, String clientDni, String clientName) {
    EmployeeEntity employeeEntity = employeeRepository.findById(employee.getId()).orElse(null);
    List<ChatDTO> chatList = new ArrayList<>();
    ...
    if (employeeEntity != null) {
      List<ChatEntity> chatEntityList =
          chatRepository.findByEmployeeAndClientDniAndClientName(
              employeeEntity, clientDni, clientName);
      chatList = this.listToDTO(chatEntityList);
    }
  ...
  public List<ChatDTO> findByEmployeeAndClientDniAndClientNameAndRecent(
      EmployeeDTO employee, String clientDni, String clientName) {
    EmployeeEntity employeeEntity = employeeRepository.findById(employee.getId()).orElse(null);
    List<ChatDTO> chatList = new ArrayList<>();
  ...
  public List<ChatDTO> findByEmployeeAndClientNameAndRecent(
      EmployeeDTO employee, String clientName) {
    EmployeeEntity employeeEntity = employeeRepository.findById(employee.getId()).orElse(null);
    List<ChatDTO> chatList = new ArrayList<>();
