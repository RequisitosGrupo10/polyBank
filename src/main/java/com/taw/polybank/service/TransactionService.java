...
public class TransactionService {
        ...
        if (filter.beneficiaryIban.isBlank()) {
          ...
          transactions =
              transactionRepository.filterByBankAccount_TimestampRange_beneficiaryIBAN_Amount(
                  bankAccountEntity, begin, end, beneficiary, filter.getAmount());
        }
      } else {
        transactions =
            transactionRepository.filterByBankAccount_TimestampRange_TransactionOwner_Amount(
                bankAccountEntity, begin, end, clients, filter.getAmount());
      }
    } else {
      transactions =
          transactionRepository
              .filterByBankAccount_TimestampRange_TransactionOwner_beneficiaryIBAN_Amount(
                  bankAccountEntity, begin, end, clients, beneficiary, filter.getAmount());
    }
  ...
  public void makeTransaction(
      ...
      String ibanReceptor,
      String nameReceptor,
      BadgeDTO finalBadgeDTO,
      BadgeDTO emisorBadgeDTO,
      BankAccountDTO bankAccountEmisorDTO,
      ClientDTO clientDTO) {
    ...
    BankAccountEntity bankAccountEmisor =
        bankAccountRepository.findByIban(bankAccountEmisorDTO.getIban()).orElse(null);
    updateBankAccounts(
        amount, ibanReceptor, finalBadge, finalAmount, emisorBadge, bankAccountEmisor);
  ...
  private void makeTransaction(
      PaymentEntity payment, ClientEntity client, BankAccountEntity bankAccount) {
  ...
  private PaymentEntity makePayment(
      double amount, BenficiaryEntity beneficiary, CurrencyExchangeEntity currencyExchange) {
  ...
  private BenficiaryEntity getOrMakeBeneficiaryEntity(
      String ibanReceptor, String nameReceptor, BadgeEntity finalBadge) {
  ...
  private TransactionEntity toEntity(
      ...
      BeneficiaryService beneficiaryService) {
    TransactionEntity transaction =
        transactionRepository.findById(transactionDTO.getId()).orElse(new TransactionEntity());
    ...
    transaction.setBankAccountByBankAccountId(
        bankAccountService.toEntity(
            transactionDTO.getBankAccountByBankAccountId(), clientService, badgeService));
    CurrencyExchangeEntity currencyExchangeEntity =
        transactionDTO.getCurrencyExchangeByCurrencyExchangeId() == null
            ? null
            : currencyExchangeService.toEntity(
                transactionDTO.getCurrencyExchangeByCurrencyExchangeId(), badgeService);
  ...
  public List<TransactionDTO> findAllTransactionsByBankAccountAndDatesAndSendAmountInRange(
  ...
  public List<TransactionDTO> findByBankIdAndFilter(int id, TransactionFilterJose filter) {
    ...
    } else return getAnyTransactionByClientIdDTOS(id, filter);
  }

  private List<TransactionDTO> getAnyTransactionByClientIdDTOS(
      Integer id, TransactionFilterJose filter) {
    ...
    } else return findByClientId(id);
  }

  private List<TransactionDTO> getCurrencyExchangeByClientIdDTOS(
      Integer id, TransactionFilterJose filter) {
    if (filter.getSorting() == null || filter.getSorting().isBlank()) {
      ...
      return findCurrencyExchangesByClientIdAndMinimumAmountSortByTimestampDesc(
          id, filter.getAmount());
    } else return findCurrencyExchangesByClientIdAndMinimumAmount(id, filter.getAmount());
  }
  ...
  private List<TransactionDTO> getPaymentByClientIdDTOS(Integer id, TransactionFilterJose filter) {
    ...
    } else return findPaymentsByClientIdAndMinimumAmount(id, filter.getAmount());
  }

  private List<TransactionDTO> getAnyTransactionByBankIdDTOS(
      Integer id, TransactionFilterJose filter) {
    if (filter.getSorting() == null || filter.getSorting().isBlank()) {
  ...
  private List<TransactionDTO> getCurrencyExchangeByBankIdDTOS(
      Integer id, TransactionFilterJose filter) {
    if (filter.getSorting() == null || filter.getSorting().isBlank()) {
      ...
      return findCurrencyExchangesByBankIdAndMinimumAmountSortByTimestampDesc(
          id, filter.getAmount());
    } else return findCurrencyExchangesByBankIdAndMinimumAmount(id, filter.getAmount());
  }

  private List<TransactionDTO> findCurrencyExchangesByBankIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount) {
    return getDtoList(
        transactionRepository.findCurrencyExchangesByBankIdAndMinimumAmountSortByTimestampAsc(
            id, amount));
  }

  private List<TransactionDTO> findCurrencyExchangesByBankIdAndMinimumAmountSortByTimestampDesc(
      Integer id, double amount) {
    return getDtoList(
  ...
  private List<TransactionDTO> findCurrencyExchangesByBankIdAndMinimumAmount(
      Integer id, double amount) {
    return getDtoList(
  ...
  private List<TransactionDTO> getPaymentByBankIdDTOS(Integer id, TransactionFilterJose filter) {
    ...
    } else return findPaymentsByBankIdAndMinimumAmount(id, filter.getAmount());
  }

  private List<TransactionDTO> findPaymentsByBankIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount) {
    return getDtoList(
        transactionRepository.findPaymentsByBankIdAndMinimumAmountSortByTimestampAsc(id, amount));
  }

  private List<TransactionDTO> findPaymentsByBankIdAndMinimumAmountSortByTimestampDesc(
      Integer id, double amount) {
    return getDtoList(
  ...
  private List<TransactionDTO> findCurrencyExchangesByClientIdAndMinimumAmountSortByTimestampDesc(
      Integer id, double amount) {
    return getDtoList(
  ...
  private List<TransactionDTO> findCurrencyExchangesByClientIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount) {
    return getDtoList(
  ...
  private List<TransactionDTO> findPaymentsByClientIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount) {
    return getDtoList(
  ...
  private List<TransactionDTO> findCurrencyExchangesByClientIdAndMinimumAmount(
      Integer id, double amount) {
    return getDtoList(
  ...
  private List<TransactionDTO> findPaymentsByClientIdAndMinimumAmountSortByTimestampDesc(
  ...
  public BankAccountDTO updateBankAccount(BankAccountDTO bankAccountEmisor) {
    BankAccountEntity bankAccountEntity =
        bankAccountRepository.findByIban(bankAccountEmisor.getIban()).orElse(null);
