...
public class AuthorizedAccountService {
  ...
  public List<AuthorizedAccountDTO> findAuthorizedAccountEntitiesOfGivenBankAccount(
      int bankAccountId) {
  ...
  public void save(
      AuthorizedAccountDTO authorizedAccount,
    ...
    accountEntity.setBankAccountByBankAccountId(
        bankAccountService.toEntity(
            authorizedAccount.getBankAccountByBankAccountId(), clientService, badgeService));
