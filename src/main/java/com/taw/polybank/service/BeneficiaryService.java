...
public class BeneficiaryService {
  ...
  @Autowired protected BeneficiaryRepository beneficiaryRepository;
  ...
  public BenficiaryEntity toEntity(BenficiaryDTO benficiaryDTO) {
    BenficiaryEntity benficiary =
        beneficiaryRepository.findById(benficiaryDTO.getId()).orElse(new BenficiaryEntity());
  ...
  public void guardarBeneficiarios(ClientDTO client) {
    ...
    for (BankAccountEntity bankAccountEntity : bankAccountEntityList) {
      ...
      BenficiaryEntity benficiaryEntity =
