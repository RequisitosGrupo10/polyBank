...
public class RequestService {
  ...
  public List<RequestDTO> findByBankAccountByBankAccountIdAndAndSolved(
      BankAccountDTO bankAccount, boolean b) {
  ...
  public RequestEntity toEntity(RequestDTO request) {
    RequestEntity requestEntity =
        requestRepository.findById(request.getId()).orElse(new RequestEntity());
  ...
  public void save(
    ...
    request.setBankAccountByBankAccountId(
        bankAccountService.toEntity(
            requestDTO.getBankAccountByBankAccountId(), clientService, badgeService));
