...
public class CurrencyExchangeService {
  ...
  @Autowired protected CurrencyExchangeRepository currencyExchangeRepository;
  ...
  public CurrencyExchangeEntity toEntity(
      CurrencyExchangeDTO currencyExchangeDTO, BadgeService badgeService) {
    CurrencyExchangeEntity currencyExchange =
        currencyExchangeRepository
            .findById(currencyExchangeDTO.getId())
            .orElse(new CurrencyExchangeEntity());
