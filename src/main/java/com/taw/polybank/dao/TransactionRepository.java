...
public interface TransactionRepository extends JpaRepository<TransactionEntity, Integer> {
  ...
  @Query(
      "select t from TransactionEntity t where t.bankAccountByBankAccountId = :bankAccount and t.timestamp >= :begin and t.timestamp <= :end and t.clientByClientId in :clients and t.paymentByPaymentId.benficiaryByBenficiaryId = :beneficiary and t.paymentByPaymentId.amount >= :amount")
  ...
  @Query(
      "select t from TransactionEntity t where t.bankAccountByBankAccountId = :bankAccount and t.timestamp >= :begin and t.timestamp <= :end and t.paymentByPaymentId.benficiaryByBenficiaryId = :beneficiary and t.paymentByPaymentId.amount >= :amount")
  List<TransactionEntity> filterByBankAccount_TimestampRange_beneficiaryIBAN_Amount(
      BankAccountEntity bankAccount,
      Timestamp begin,
      Timestamp end,
      BenficiaryEntity beneficiary,
  ...
  @Query(
      "select t from TransactionEntity t where t.bankAccountByBankAccountId = :bankAccount and t.timestamp >= :begin and t.timestamp <= :end and t.clientByClientId in :clients and t.paymentByPaymentId.amount >= :amount")
  List<TransactionEntity> filterByBankAccount_TimestampRange_TransactionOwner_Amount(
      BankAccountEntity bankAccount,
      Timestamp begin,
      Timestamp end,
      List<ClientEntity> clients,
  ...
  @Query(
      "select t from TransactionEntity t where t.bankAccountByBankAccountId = :bankAccount and t.timestamp >= :begin and t.timestamp <= :end and t.paymentByPaymentId.amount >= :amount")
  List<TransactionEntity> filterByBankAccount_TimestampRange_Amount(
      BankAccountEntity bankAccount, Timestamp begin, Timestamp end, double amount);

  List<TransactionEntity> findTransactionEntitiesByBankAccountByBankAccountIdId(Integer id);

  @Query(
      "select trans from TransactionEntity trans where "
  ...
  @Query(
      "select transactionEntity from TransactionEntity transactionEntity where transactionEntity.clientByClientId.id = :id")
  List<TransactionEntity> findByClientId(int id);

  @Query(
      "select transactionEntity from TransactionEntity transactionEntity "
  ...
  List<TransactionEntity> findCurrencyExchangesByClientIdAndMinimumAmount(
  ...
  List<TransactionEntity> findPaymentsByClientIdAndMinimumAmountSortByTimestampDesc(
  ...
  List<TransactionEntity> findPaymentsByClientIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount);
  ...
  @Query(
      "select transactionEntity from TransactionEntity transactionEntity "
          ...
          + "order by transactionEntity.timestamp asc ")
  List<TransactionEntity> findCurrencyExchangesByBankIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount);
  ...
  @Query(
      "select transactionEntity from TransactionEntity transactionEntity "
          ...
          + "and (currency != null and currency.initialAmount > :amount) "
          + "order by transactionEntity.timestamp desc ")
  List<TransactionEntity> findCurrencyExchangesByBankIdAndMinimumAmountSortByTimestampDesc(
      Integer id, double amount);
  ...
  @Query(
      "select transactionEntity from TransactionEntity transactionEntity "
          ...
          + "and (payment != null and payment.amount > :amount) "
          + "order by transactionEntity.timestamp asc ")
  List<TransactionEntity> findPaymentsByBankIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount);
  ...
  @Query(
      "select transactionEntity from TransactionEntity transactionEntity "
          ...
          + "and (payment != null and payment.amount > :amount) "
          + "order by transactionEntity.timestamp desc")
  List<TransactionEntity> findPaymentsByBankIdAndMinimumAmountSortByTimestampDesc(
      Integer id, double amount);
  ...
  @Query(
      "select transactionEntity from TransactionEntity transactionEntity "
          ...
          + "and (currency != null and currency.initialAmount > :amount) "
          + "order by transactionEntity.timestamp desc ")
  List<TransactionEntity> findCurrencyExchangesByClientIdAndMinimumAmountSortByTimestampDesc(
      Integer id, double amount);
  ...
  @Query(
      "select transactionEntity from TransactionEntity transactionEntity "
          ...
          + "and (currency != null and currency.initialAmount > :amount) "
          + "order by transactionEntity.timestamp asc ")
  List<TransactionEntity> findCurrencyExchangesByClientIdAndMinimumAmountSortByTimestampAsc(
      Integer id, double amount);
}
