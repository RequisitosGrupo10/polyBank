...
public class ClientController {
  ...
  public String addClient(
      @ModelAttribute("client") ClientDTO client, @RequestParam("password") String password) {
  ...
  public String viewBankAccount(
      @RequestParam("id") Integer accountID, Model model, HttpSession session) {
    ClientDTO clientDTO = (ClientDTO) session.getAttribute("client");
    if (clientDTO == null) return "redirect:/";
  ...
  public String processTransfer(
    ...
    model.addAttribute(
        ...
        amount
            + " "
            + account.getBadgeByBadgeId().getName()
  ...
  public String makeExchange(
      @RequestParam("badge") Integer badgeID, HttpSession session, Model model) {
    ...
    TransactionDTO transaction = defineTransaction(clientDTO, account);
    BenficiaryDTO beneficiary =
        beneficiaryService.findBenficiaryByNameAndIban(clientDTO.getName(), account.getIban());
    ...
    if (currentBadge.getId() != targetBadge.getId()) {
      CurrencyExchangeDTO currencyExchange =
          defineCurrencyExchange(
              currentBadge, targetBadge, account.getBalance(), transaction, payment);
      transaction.setPaymentByPaymentId(payment);
  ...
  private String operationHistoryFilters(
    ...
    if (transactionFilter == null) {
      transactionList =
          transactionService.findTransactionsByBankAccountByBankAccountIdId(account.getId());
  ...
  public String doMakeUnbanPetition(
